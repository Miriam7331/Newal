<script setup>
import FormDialog from "@/Components/Entities/Entity/FormDialog.vue"
...
endPoint.value = "/dashboard/entities"
</script>
...
<template>
  ...
  <v-card elevation="6" class="mt-5 mr-5 ml-5 ml-md-0" variant="outlined">
    <v-data-table-server
      :loading="loading"
      multi-sort
