<script setup>
import FormDialog from "@/Components/Entities/Center/FormDialog.vue"
...
const headers = [
  ...
  { title: "Isla", key: "island", align: "center" },
  {
    title: "Acciones",
    key: "actions",
    align: "center",
...
endPoint.value = "/dashboard/centers"
</script>
...
<template>
  ...
  <v-card elevation="6" class="mt-5 ml-5 mr-5 mr-md-0" variant="outlined">
    <v-data-table-server
      :loading="loading"
      multi-sort
