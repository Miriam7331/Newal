<script setup>
import FormDialog from "@/Components/Teacher/FormDialog.vue"
...
const headers = [
  ...
  { title: "Apellidos", key: "surnames", align: "center" },
  { title: "Información", key: "info", align: "center" },
  {
    title: "Acciones",
    key: "actions",
    align: "center",
...
endPoint.value = "/dashboard/teachers"
</script>
